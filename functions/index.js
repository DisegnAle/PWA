...
.onRequest(function(request, response) {
  return cors(request, response, function() {
    ...
    busboy.on("finish", () => {
      var bucket = gcs.bucket("pwagram-e67f6.appspot.com");
      bucket.upload(
        upload.file,
        {
          uploadType: "media",
            ...
            admin
              ...
              .then(function() {
                webpush.setVapidDetails(
                  "mailto:a.scaiola@gmail.com",
                  "BH0bKFbBJYokOiwwqMKr-xyXm6QTQToA1To3GipWndLrNJXbdOtNSg_vDF7fPHqkjPx8dVCg8v3EwGmzbGd4x6Q",
                  "rzjAgohlQ_9n80xPNxCBL1J-J3ngve-38rMYdGE8WDw"
                );
                return admin
                  .database()
                  .ref("subscriptions")
